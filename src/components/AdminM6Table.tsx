                ...
                <tr key={category.key} className={categoryIndex % 2 === 0 ? 'bg-gray-50 hover:bg-gray-75' : 'bg-gray-75 hover:bg-gray-100'}>
                  ...
                  <td className="border border-gray-200 p-0.5 align-top" style={{width: '25%'}}>
                    <Textarea
                      ...
                      disabled
                      className="text-xs bg-white border border-gray-300 text-gray-900 rounded-lg min-h-[75px] resize-none w-full cursor-default"
                      rows={4}
                    />
                  </td>
                    ...
                    <div className="space-y-0.5">
                      <div>
                        ...
                        <Input
                          ...
                          disabled
                          className="text-xs h-5 bg-white border border-gray-300 text-gray-900 rounded-lg font-medium w-full cursor-default"
                        />
                      </div>
                      <div>
                        <Textarea
                          ...
                          disabled
                          className="text-xs bg-white border border-gray-300 text-gray-900 rounded-lg min-h-[38px] resize-none w-full cursor-default"
                          rows={2}
                        />
                      </div>
                    </div>
              ...
              <tr className="bg-gradient-to-r from-red-50 to-red-100 font-semibold">
                <td className="border border-gray-200 py-2 px-1 text-center" colSpan={3}>
                  <Input
                    ...
                    disabled
                    className="text-center bg-white border border-gray-300 text-gray-900 text-base font-bold cursor-default"
                  />
                </td>
